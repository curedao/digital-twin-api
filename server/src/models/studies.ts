...
export class studies extends Model<studiesAttributes, studiesAttributes> implements studiesAttributes {
    ...
    @Column({
    	...
    	comment: "The type of study may be population, individual, or cohort study" 
    })
    @Index({
    	name: "user_cause_effect_type",
    	using: "btree",
    	unique: true 
    })
    	type?: string;
    ...
    @Index({
    	name: "studies_cause_variable_id",
    	using: "btree",
    	unique: false 
    })
    	causeVariableId?: number;
    ...
    @Index({
    	name: "studies_effect_variable_id",
    	using: "btree",
    	unique: false 
    })
    	effectVariableId?: number;
